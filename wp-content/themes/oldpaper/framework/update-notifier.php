...
define( 'NOTIFIER_THEME_NAME', 'Old Paper' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'oldpaper' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://www.thunderthemes.net/updatenotifier/oldpaper.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
define( 'NOTIFIER_CACHE_INTERVAL', 1 ); // The time interval for the remote XML cache in the database (21600 seconds = 6 hours)
