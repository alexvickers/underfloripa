    ...
    class Redux_Framework_sample_config {
        ...
        function compiler_action($options, $css, $changed_values) {
            ...
            //print_r($css); // Compiler selector CSS values  compiler => array( CSS SELECTORS )
              ...
              $filename = dirname(__FILE__) . '/style-marco' . '.css';
...
//                        )
            ...
            $this->sections[] = array(
                ...
                'desc'      => __('<p class="description">Follow us on <a href="https://www.facebook.com/ThunderThemes?fref=ts">Facebook</a> or visit our <a href="http://www.thunderthemes.net/">website</a> for support.</p>', 'redux-framework-demo'),
                'fields'    => array(
                    array(
                        'id'        => 'opt-raw-info',
                        'type'      => 'raw',
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'menu_title'        => __('OldPaper Theme', 'redux-framework-demo'),
                'page_title'        => __('OldPaper Theme', 'redux-framework-demo'),
            ...
            if (!isset($this->args['global_variable']) || $this->args['global_variable'] !== false) {
                ...
                $this->args['intro_text'] = sprintf(__('<p>If you need help see <a href="http://docs.thunderthemes.net/oldpaper/" target="_blank">Template Documentation</a></p>', 'redux-framework-demo'), $v);
            } else {
                $this->args['intro_text'] = __('<p>Thank you for purchasing one of our Premium Wordpress Themes!</p>', 'redux-framework-demo');
            }

            // Add content after the form.
            $this->args['footer_text'] = __('<p>A huge thank you for purchasing our WordPress Theme at ThemeForest.</p>', 'redux-framework-demo');
        }
