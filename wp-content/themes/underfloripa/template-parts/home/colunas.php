...
<section class="home-section colunas-grid">
	<div class="title">
		<h2>Colunas</h2>
		<a href="<?php echo get_category_link(get_category_by_slug('colunas')->term_id); ?>" class="button">Todas as colunas</a>
	</div>
				...
				<div class="coluna-card<?php echo $category_classes; ?>">
					...
					<a href="<?php the_permalink(); ?>">
						<?php if (has_post_thumbnail()) :
							$thumb_url = get_the_post_thumbnail_url(get_the_ID(), 'medium', ['alt' => get_the_title()]);
						endif; ?>
