...
<body <?php body_class(); ?>>
	...
	<header id="site-header" role="banner">
		<div class="site-container top">
				...
				<?php if (is_front_page()) { ?>
					<h1 class="site-title">
						<span class="logo-svg" aria-hidden="true">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/logo-underfloripa.svg" alt="Under Floripa Logo" role="presentation" />
						</span>
			...
			<div class="lazy-google-ad header-ad header-right"
				data-ad-client="ca-pub-2855642712528671"
				data-ad-slot="5367126541">
			...
			<div class="nav-container site-container">
				...
				<div class="nav-right">
					...
					<div class="header-socials">
						...
						<a href="https://web.facebook.com/Underfloripa" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
								<path d="M160 96C124.7 96 96 124.7 96 160L96 480C96 515.3 124.7 544 160 544L258.2 544L258.2 398.2L205.4 398.2L205.4 320L258.2 320L258.2 286.3C258.2 199.2 297.6 158.8 383.2 158.8C399.4 158.8 427.4 162 438.9 165.2L438.9 236C432.9 235.4 422.4 235 409.3 235C367.3 235 351.1 250.9 351.1 292.2L351.1 320L434.7 320L420.3 398.2L351 398.2L351 544L480 544C515.3 544 544 515.3 544 480L544 160C544 124.7 515.3 96 480 96L160 96z" />
							</svg>
						</a>
						<a href="https://x.com/underfloripa" aria-label="X (Twitter)" target="_blank" rel="noopener noreferrer">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
								<path d="M160 96C124.7 96 96 124.7 96 160L96 480C96 515.3 124.7 544 160 544L480 544C515.3 544 544 515.3 544 480L544 160C544 124.7 515.3 96 480 96L160 96zM457.1 180L353.3 298.6L475.4 460L379.8 460L305 362.1L219.3 460L171.8 460L282.8 333.1L165.7 180L263.7 180L331.4 269.5L409.6 180L457.1 180zM419.3 431.6L249.4 206.9L221.1 206.9L392.9 431.6L419.3 431.6z" />
							</svg>
						</a>
						<a href="https://chat.whatsapp.com/CB1CGgIEaNLJiRMeeG9AHJ?mode=ems_copy_c" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
