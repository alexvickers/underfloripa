		...
		<div class="site-container">
			<div class="header-container">
				<a class="header-left" href="<?php echo home_url(); ?>" target="_self">
					<img class="site-logo" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/logo.png" />
